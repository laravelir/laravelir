 <header class="navbar navbar-expand-md navbar-light d-print-none">
    <div class="container-xl">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href=".">
                <img src="{{ asset('/statics/shared/images/laravel-logolockup-rgb-red.svg') }}" width="110"
                    height="32" alt="Tabler" class="navbar-brand-image" style="height: 3em!important;">
            </a>
        </h1>
        <div class="navbar-nav flex-row order-md-last">
            <div class="nav-item d-none d-md-flex me-3">
                <div class="btn-list">
                    <a href="https://github.com/laravelir" class="btn" target="_blank" rel="noreferrer">
                    ...
                    <a href="https://github.com/laravelir/sponsors" class="btn" target="_blank"
                        rel="noreferrer">
            ...
            @auth
                ...
                @include('shared.widgets.profile_dropdown')
            @else
            <div class="nav-item d-none d-md-flex me-3">
                <div class="btn-list">
        ...
        <div class="navbar navbar-light">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('site.discussions.index') }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('site.users.index') }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                <!-- Download SVG icon from http://tabler-icons.io/i/checkbox -->
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                    viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
