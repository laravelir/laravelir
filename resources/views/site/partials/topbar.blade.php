<header class="navbar navbar-expand-md navbar-light d-print-none">
    <div class="container-xl">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href=".">
                <img src="{{ asset('/statics/shared/images/laravel-logolockup-rgb-red.svg') }}" width="110" height="32" alt="Tabler" class="navbar-brand-image" style="height: 3em!important;">
            </a>
        </h1>
        <div class="navbar-nav flex-row order-md-last">
            <div class="nav-item d-none d-md-flex me-3">
                <div class="btn-list">
                    <a href="https://github.com/laravelir" class="btn" target="_blank"
                        rel="noreferrer">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                    ...
                    <div class="d-none d-xl-block ps-2">
                        <div>تیلور اتول</div>
                        <div class="mt-1 small text-muted">برنامه نویس</div>
                    </div>
                </a>
