...
@section('page-title')
    <div class="">
        پروژه ها
        <p class="text-muted mt-1" style="font-size: .7rem !important;">{{ $projects->count() }} پروژه</p>
    </div>
@endsection
...
@section('breadcrumb')
    <li class="breadcrumb-item active"><a href="{{ route('site.projects.index') }}">پروژه ها</a></li>
@endsection
    ...
    <div class="row g-4">
        <div class="col-3">
            <form action="" method="get">
                ...
                <div class="subheader mb-2">نوع پروژه</div>
                <div>
        ...
        <div class="col-9">
            <div class="row row-cards">
                ...
                @empty
                    <x-alert type='' level='warning' message='هنوز پروژهی ثبت نشده است.'></x-alert>
                @endforelse
            </div>
        </div>
    </div>
