...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item "><a href="{{ route('account.projects.index') }}">پروژه ها</a></li>
    <li class="breadcrumb-item active"><a href="{{ route('account.projects.create') }}">ثبت پروژه جدید</a></li>
@endsection
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <div class="form-group mb-3">
                        ...
                        <div>
                            <input type="text" class="form-control" value="{{ old('usernmae') }}">
                    ...
                    <div class="form-group mb-3 ">
                        ...
                        <div>
                            <input type="text" class="form-control" name="mobile" id="mobile"
                                value="{{ old('mobile') }}" placeholder="9128558555">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-8 mx-auto">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="bio" rows="5" placeholder="درباره خود، شغل، علایق و ...">{{ old('bio') }}</textarea>
                    </div>
                </div>
            </div>
            <div class="form-group mb-3 ">
