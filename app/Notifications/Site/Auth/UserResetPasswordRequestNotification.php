...
use App\Mail\Site\Auth\User\ResetPasswordRequestMail;
...
class UserResetPasswordRequestNotification extends Notification implements ShouldQueue
{
    ...
    {
        // $channel = $this->type === 'mail' ? ['mail'] : [SMSKavenegarChannel::class];
    ...
    {
        $url = route('customer.auth.password.reset', $this->token);
